...
N = 200  # Population size - default = 100
...
p = 1  # Polarisation
trials = 100000  # Number of trials, keep min around 10*N. Takes around N generations to reach fixation
...
if log:
    #TODO Change back to np.arange(rmin, rmax, steps)
